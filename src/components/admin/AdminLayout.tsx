...
import { Home, Building2, Gem, Ticket, Users, Star, Bell, LogOut, Menu, X, ChevronRight } from "lucide-react";
        ...
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto">
          ...
          <div className="flex items-center justify-center px-4 mb-8">
            <Link to="/admin" className="flex flex-col items-center">
              <h1 className="text-2xl font-display font-bold text-primary">New Kalyani</h1>
              <p className="text-sm text-muted-foreground">Jewellers Admin</p>
            </Link>
          </div>
            ...
            <div className="flex flex-col h-full">
              <div className="flex items-center justify-between px-4 py-5">
                <Link to="/admin" className="flex flex-col" onClick={() => setSidebarOpen(false)}>
                  <h1 className="text-xl font-display font-bold text-primary">New Kalyani</h1>
                  <p className="text-xs text-muted-foreground">Jewellers Admin</p>
                </Link>
